      ...
      <Box maxW="7xl" mx="auto" px={6} py={10}>
        ...
        <SimpleGrid columns={{ base: 1, md: 4 }} spacing={10}>
          ...
          <Box>
            ...
            <VStack align="start" spacing={2} fontSize="sm">
              <ChakraLink as={Link} to="/cancellation-refund" _hover={{ color: "teal.400" }}>
                Cancellation Refund
              </ChakraLink>
              <ChakraLink as={Link} to="/privacy-policy" _hover={{ color: "teal.400" }}>
               Privacy Policy
              </ChakraLink>
              <ChakraLink as={Link} to="/terms-and-conditions" _hover={{ color: "teal.400" }}>
          ...
          <Box>
            ...
            <HStack spacing={2}>
              <Input
                ...
                _focus={{ bg: "gray.700" }}
              />
              <Button colorScheme="teal" isDisabled={isAdmin}>Subscribe</Button>
            </HStack>
          </Box>
